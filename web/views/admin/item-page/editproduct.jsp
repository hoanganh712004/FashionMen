            ...
            <jsp:include page="../../common/admin/leftmainsidebar.jsp"></jsp:include>
                ...
                <jsp:include page="../../common/admin/header.jsp"></jsp:include>
                    ...
                    <div class="ec-content-wrapper">
                        ...
                        <form id="f" action="${pageContext.request.contextPath}/editproduct" method="POST" class="row g-3" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-12">
                                                    ...
                                                    <div class="ec-vendor-upload-detail">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <select name="category" id="Categories" class="form-select">
                                                                <c:forEach items="${sessionScope.categorysAdminList}" var="category">
                                                        ...
                                                        <div style="margin-top: 30px " class="col-md-6">
                                                            ...
                                                            <select name="supperlier" id="supperlier" class="form-select">
                                                                <c:forEach items="${sessionScope.supperlierAdminList}" var="supperlier">
                                                        ...
                                                        <div  style="margin-top: 30px " class="col-md-12">
                                                            ...
                                                            <textarea
                                                                ...
                                                                >${editProduct.desciption}</textarea>
                                                        </div>
