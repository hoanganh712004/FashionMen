                ...
                <div class="col-lg-6 col-md-10">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body p-5">
                            <h4 class="text-dark mb-5">New password</h4>

                            <form action="${pageContext.request.contextPath}/updatenewpassword" method="GET">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group col-md-12 mb-4">
                                            <input placeholder="New password" class="form-control" type="password" name="npassword" value="" required/>
                                        </div>
