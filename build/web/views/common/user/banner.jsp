                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-12  d-flex align-items-center justify-content-md-end justify-content-start">
                            <div class="hero-content-left  d-flex align-items-center">
                                <div class="hero-inner">
                                    ...
                                    <div class="btn_box">
                                        <a href="${pageContext.request.contextPath}/filterproduct">Explore Now</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-12  d-flex align-items-center justify-content-md-end justify-content-start">
                            <div class="hero-content-left  d-flex align-items-center">
                                <div class="hero-inner">
                                    ...
                                    <div class="btn_box">
                                        <a href="${pageContext.request.contextPath}/filterproduct?minPrice=${sessionScope.minPrice}&maxPrice=${sessionScope.maxPrice}&orderBy=0">Explore Now</a>
                                    </div>
                                </div>
                            </div>
                        </div>
