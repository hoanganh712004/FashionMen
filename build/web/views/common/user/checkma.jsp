                ...
                <div class="col-lg-6 col-md-10">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body p-5">
                            ...
                            <form action="${pageContext.request.contextPath}/forgetPassword" method="GET">
                                <div class="row">
                                    <div class="form-group col-md-12 mb-4">
                                        <input placeholder="Email" class="form-control" type="text" name="email" value="${checkEmail}" required/>
                                    </div>

                                    <div class="form-group col-md-12 mb-4">
                                        <input placeholder="Verification Code" class="form-control" type="text" name="ma" value="" required/>
                                    </div>


                                    <div class="col-md-12">

                                        <c:if test="${errorMa != null}">
                                            <div id="errorBox" class="error-message" >${errorMa}</div>
                                        </c:if>
