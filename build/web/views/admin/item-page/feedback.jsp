                                        ...
                                        <div class="card-body">
                                            <div class="table-responsive">
                                                <table id="responsive-data-table" class="table" style="width:100%">
                                                    ...
                                                    <tbody>
                                                    <c:forEach items="${feedbackAll}" var="feedback">
                                                        <tr>
                                                            <td><img class="tbl-thumb" src="${pageContext.request.contextPath}/${feedback.user.image}" alt="product image"/></td>
                                                            <td><a href="${pageContext.request.contextPath}/edituser?userId=${feedback.user.userId}">${feedback.user.userName}</a></td>
                                                            <td>${feedback.note}</td>
                                                            ...
                                                            <td>
                                                                <div class="btn-group mb-1">
                                                                    ...
                                                                    <div class="dropdown-menu">
                                                                        ...
                                                                        <a class="dropdown-item" href="${pageContext.request.contextPath}/editFeedback?feedbackId=${feedback.feedbackId}">Edit</a>

                                                                        <a class="dropdown-item" onclick="deleteComment('${pageContext.request.contextPath}/deleteFeedback?feedbackId=${feedback.feedbackId}')" href="javascript:void(0)">Delete</a>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>   
